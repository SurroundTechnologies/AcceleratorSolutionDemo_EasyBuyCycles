...
namespace WPF.ShippingAddress
{
	...
	public partial class  ShippingAddressExpContent : AB_ContentWindowBase
	{
		...
		private static void RG_StaticInit()
		{
			...
			AB_SystemController.ap_SystemPropertyMethods.am_EnrollResourceCultureInfo(typeof(ShippingAddressExpContent), WPF.EasyBuyCycles.Views.Properties.Resources.Culture);
		}
