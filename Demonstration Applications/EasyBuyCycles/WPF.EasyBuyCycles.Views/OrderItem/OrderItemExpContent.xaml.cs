...
namespace WPF.OrderItem
{
	...
	/// </summary>
	public partial class  OrderItemExpContent : AB_ContentWindowBase
	{
		...
		/// Constructor
		/// </summary>
		public OrderItemExpContent(AB_VisualComponentInitializationArgs initializationArgs)
		...
		private static void RG_StaticInit()
		{
			...
			AB_SystemController.ap_SystemPropertyMethods.am_EnrollResourceCultureInfo(typeof(OrderItemExpContent), WPF.EasyBuyCycles.Views.Properties.Resources.Culture);
		}
		...
		private void RG_SetParentProperties()
		{
			...
			ap_DataMaps = new OrderItemMaps().ap_FieldMaps;
			_ViewModel = FindResource("OrderItemVM") as OrderItemVM;
			ap_ViewModel = _ViewModel;
			ap_MainDetailType = typeof(OrderItemDetail);
		}
