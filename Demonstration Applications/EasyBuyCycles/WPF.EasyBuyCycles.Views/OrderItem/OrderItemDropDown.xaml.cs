...
{
	/// <summary>
	/// Interaction logic for OrderItemDropDown.xaml
	/// </summary>
	public partial class  OrderItemDropDown : AB_DropDownBase
	{
		/// <summary>
		...
		public static readonly DependencyProperty InternalIDProperty = DependencyProperty.Register("InternalID", typeof(int?), typeof(OrderItemDropDown), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.BindsTwoWayByDefault, new PropertyChangedCallback(AB_DropDownBase.IdChanged)));
