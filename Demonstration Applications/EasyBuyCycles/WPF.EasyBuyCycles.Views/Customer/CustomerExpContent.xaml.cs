...
namespace WPF.Customer
{
	...
	public partial class  CustomerExpContent : AB_ContentWindowBase
	{
		...
		private static void RG_StaticInit()
		{
			...
			AB_SystemController.ap_SystemPropertyMethods.am_EnrollResourceCultureInfo(typeof(CustomerExpContent), WPF.EasyBuyCycles.Views.Properties.Resources.Culture);
		}
