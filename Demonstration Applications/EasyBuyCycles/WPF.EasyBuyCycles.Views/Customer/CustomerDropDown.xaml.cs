...
namespace WPF.Customer
{
	...
	public partial class  CustomerDropDown : AB_DropDownBase
	{
		...
		public static readonly DependencyProperty InternalIDProperty = DependencyProperty.Register("InternalID", typeof(int?), typeof(CustomerDropDown), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.BindsTwoWayByDefault, new PropertyChangedCallback(AB_DropDownBase.IdChanged)));
		...
		protected override void am_SetParentProperties()
		{
			...
			ap_CurrentView = "Customer";
			
			//The name of the property that should be displayed in the Drop Down
			ap_ComboBoxDisplayMemberPath = CustomerEntity.InternalIDProperty.ap_PropertyName;
