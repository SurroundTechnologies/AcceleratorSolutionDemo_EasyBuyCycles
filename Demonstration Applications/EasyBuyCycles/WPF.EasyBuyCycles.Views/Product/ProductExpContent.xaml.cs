...
namespace WPF.Product
{
	...
	public partial class  ProductExpContent : AB_ContentWindowBase
	{
		...
		/// Constructor
		/// </summary>
		public ProductExpContent(AB_VisualComponentInitializationArgs initializationArgs)
		...
		private static void RG_StaticInit()
		{
			...
			AB_SystemController.ap_SystemPropertyMethods.am_EnrollResourceCultureInfo(typeof(ProductExpContent), WPF.EasyBuyCycles.Views.Properties.Resources.Culture);
		}
		...
		private void RG_SetParentProperties()
		{
			...
			ap_DataMaps = new ProductMaps().ap_FieldMaps;
			_ViewModel = FindResource("ProductVM") as ProductVM;
			ap_ViewModel = _ViewModel;
			ap_MainDetailType = typeof(ProductDetail);
		}
		...
		protected override void am_BeforeProcessCommand(AB_Command command, RoutedEventArgs e)
		{
		    ...
		    //var selectedEntity = ap_SelectedEntity as ProductEntity;
