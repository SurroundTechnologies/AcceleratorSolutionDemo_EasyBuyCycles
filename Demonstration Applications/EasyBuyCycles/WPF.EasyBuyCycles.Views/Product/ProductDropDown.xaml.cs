...
namespace WPF.Product
{
	...
	public partial class  ProductDropDown : AB_DropDownBase
	{
		...
		public static readonly DependencyProperty InternalIDProperty = DependencyProperty.Register("InternalID", typeof(int?), typeof(ProductDropDown), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.BindsTwoWayByDefault, new PropertyChangedCallback(AB_DropDownBase.IdChanged)));
		...
		protected override void am_SetParentProperties()
		{
			...
			ap_CurrentView = "Product";
			
			//The name of the property that should be displayed in the Drop Down
			ap_ComboBoxDisplayMemberPath = ProductEntity.InternalIDProperty.ap_PropertyName;
