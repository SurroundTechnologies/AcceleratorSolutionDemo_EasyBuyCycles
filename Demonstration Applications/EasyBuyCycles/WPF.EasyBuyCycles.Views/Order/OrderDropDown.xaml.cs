...
namespace WPF.Order
{
	...
	public partial class  OrderDropDown : AB_DropDownBase
	{
		...
		public static readonly DependencyProperty InternalIDProperty = DependencyProperty.Register("InternalID", typeof(int?), typeof(OrderDropDown), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.BindsTwoWayByDefault, new PropertyChangedCallback(AB_DropDownBase.IdChanged)));
		...
		protected override void am_SetParentProperties()
		{
			...
			ap_CurrentView = "Order";
			
			//The name of the property that should be displayed in the Drop Down
			ap_ComboBoxDisplayMemberPath = OrderEntity.InternalIDProperty.ap_PropertyName;
