...
// <A4DN_Template Name="WPF.System.Application.t4" Version="8.0.0.75" GeneratedDate="7/21/2023" />
// </A4DN_GeneratedInformation>
//===============================================================================================
using System;
...
namespace WPF.EasyBuyCycles
{
	...
	public partial class App : AB_Application
	{
		...
		{   
			base.am_MergeAdditionalResources(new Uri("WPF.EasyBuyCycles.Shared;component/Resources/ApplicationResourceDictionary.xaml", UriKind.Relative));
		...
		protected override void am_OnThemeChanged(string newThemeID)
		{
			...
			switch (newThemeID)
			{
				case AB_ThemeModel.ap_GraphiteThemeID:
					base.am_MergeAdditionalResources(new Uri("WPF.EasyBuyCycles.Shared;component/Resources/Themes/GraphiteThemeResourceDictionary.xaml", UriKind.Relative));
					break;
				case AB_ThemeModel.ap_SoftBlueThemeID:
					base.am_MergeAdditionalResources(new Uri("WPF.EasyBuyCycles.Shared;component/Resources/Themes/SoftBlueThemeResourceDictionary.xaml", UriKind.Relative));
					break;
				case AB_ThemeModel.ap_SoftGreenThemeID:
					base.am_MergeAdditionalResources(new Uri("WPF.EasyBuyCycles.Shared;component/Resources/Themes/SoftGreenThemeResourceDictionary.xaml", UriKind.Relative));
					break;
				case AB_ThemeModel.ap_BlackThemeID:
                    base.am_MergeAdditionalResources(new Uri("WPF.EasyBuyCycles.Shared;component/Resources/Themes/BlackThemeResourceDictionary.xaml", UriKind.Relative));
					break;
				default:
					break;
			}
