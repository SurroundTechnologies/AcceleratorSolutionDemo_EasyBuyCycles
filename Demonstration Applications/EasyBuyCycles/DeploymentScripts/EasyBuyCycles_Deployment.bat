...
set PublisherName="My Company"
set CompanyName="My Company"
set SystemName="EasyBuyCycles"
pushd ..
set SolutionFolder=%cd%
popd
@echo Solution Folder: %SolutionFolder%
set SolutionSystemName=EasyBuyCycles
set BuildScriptLocation=..\BuildScripts\EasyBuyCycles_msbuild.bat
set DeploymentFolder=C:\Deployments\EasyBuyCycles\_Publish

set WPFAppConfigLocation=..\WPF.EasyBuyCycles\App.config
set WPFProjectLocation=..\WPF.EasyBuyCycles\WPF.EasyBuyCycles.csproj
set BPServiceHostProjectLocation=..\ServiceHost.EasyBuyCycles.BP\ServiceHost.EasyBuyCycles.BP.csproj
...
set ClickOnceIconName="MyApplicationSquare.ico"
set EnvID1Name=DEV
set EnvID1IconPath="%SolutionFolder%\WPF.EasyBuyCycles\MyApplicationSquare.ico"
set EnvID1InstallationFolderURL="http://YourDomainName/YourEnvIDSystemFolderName/BPServices/installer/"
set EnvID2Name=TST
set EnvID2IconPath="%SolutionFolder%\WPF.EasyBuyCycles\MyApplicationSquare.ico"
set EnvID2InstallationFolderURL=""
set EnvID3Name=PRO
set EnvID3IconPath="%SolutionFolder%\WPF.EasyBuyCycles\MyApplicationSquare.ico"
