...
// Product Comand Call Back Functions: Product.js

ProductExplorerComandCallBackFunctions = {
    afterPageLoad: function (guid) {
        // console.debug("afterPageLoad_ProductExplorer_" + guid);
    ...
    beforeProcessCommand: function (guid, commandID, $command, table, $row, $selectedRows) {
        // console.debug("beforeProcessCommand_ProductExplorer_" + guid, commandID);
    ...
    afterProcessCommand: function (guid, commandID, $command) {
        // console.debug("afterProcessCommand_ProductExplorer_" + guid, commandID);
    ...
    beforeDataGridAjaxProcessRequestPost: function (guid, $table, $row, commandID, data) {
        // console.debug("beforeDataGridAjaxProcessRequestPost_ProductExplorer_" + guid, $table, $row, commandID, data);
    ...
    beforeShowModalSearch: function ($modal, guid) {
        // console.debug("afterShowModalSearch_ProductExplorer_" + guid, $modal);
    ...
    afterShowModalSearch: function ($modal, guid) {
        ...
        // window.SearchFormModel_Product = model;   // For console runtime access
        // ProductExplorerFunctions.initializeSearchExplorer(model);

        // No return value expected
    }
};

ProductDetailComandCallBackFunctions = {
    beforePreview: function (tableGuid, table, $row, url) {
        // console.debug("beforePreview_ProductDetail", tableGuid, table, $row, url);
    ...
    afterPageLoad: function (guid, commandID) {
        // console.debug("afterPageLoad_ProductDetail_" + guid, commandID);
        ...
        // window.FormModel_Product = model; // For console runtime access
        ...
        //     case "COPY":
        //     case "COPYFOR":
        //         ProductDetailFunctions.initializePage(model);
        //         break;
        //
        //     case "PREVIEW":
        //         break;
    ...
    beforeProcessCommand: function (guid, commandID, $command) {
        // console.debug("beforeProcessCommand_ProductDetail_" + guid, commandID);
    ...
    afterProcessCommand: function (guid, commandID, $command) {
        // console.debug("afterProcessCommand_ProductDetail_" + guid, commandID);
...
ProductDataTablesCallBackFunctions = {
    setOptions: function (options) {
        // console.debug('setOptions_Product', options);
    },

    ajaxCallStarted: function (guid, e, settings, data) {
        // console.debug('ajaxCallStarted_Product', guid, e, settings, data);
    },

    ajaxCallCompleted: function (guid, e, settings, json, xhr) {
        // console.debug('ajaxCallCompleted_Product', guid, e, settings, json, xhr);
    },

    preDrawCallback: function (guid) {
        // console.debug('preDrawCallback_Product', guid);
    },

    rowCallback: function (guid, nRow) {
        // console.debug('rowCallback_Product', guid, nRow);
    },

    createdRow: function (guid, row, data, dataIndex, $table) {
        // console.debug('createdRow_Product', guid, row, data, dataIndex, $table);
    },

    createdCell: function (guid, td, cellData, rowData, row, col) {
        // console.debug('createdCell_Product', guid, td, cellData, rowData, row, col);
    },

    renderedCell: function (data, type, full, meta) {
        // console.debug('renderedCell_Product', data, type, full, meta);

        return data;
    },

    headerCallback: function (guid, thead, data, start, end, display) {
        // console.debug('headerCallback_Product', guid, thead, data, start, end, display);
    },

    footerCallback: function (guid, tfoot, data, start, end, display) {
        // console.debug('footerCallback_Product', guid, tfoot, data, start, end, display);
    },

    formatNumber: function (guid, toFormat) {
        // console.debug('formatNumber_Product', toFormat);

		return toFormat;
    },

    infoCallback: function (guid, settings, start, end, max, total, pre) {
        // console.debug('infoCallback_Product', guid, settings, start, end, max, total, pre);
		
		return pre;
    },

    drawCallback: function (guid, settings) {
        // console.debug('drawCallback_Product', guid, settings);
    },

    initComplete: function (guid, settings, json) {
        // console.debug('initComplete_Product', guid, settings, json);
    }
};
