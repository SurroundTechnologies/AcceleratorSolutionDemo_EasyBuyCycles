...
using A4DN.AM.BOS.PC_PropertyTypesDataEntity;
using A4DN.AM.BOS.PC_PropertyTypesDataMaps;
using A4DN.AM.BOS.PC_PropertyTypesViewModel;
using System.Web.Mvc;

namespace A4DN.AM.MVC.AcceleratorMaintenance.Controllers
{
	/// <summary>
    /// Class PC_PropertyTypesController.
    /// </summary>
    [Authorize]
    [AB_CompressContent]
    public class PC_PropertyTypesController : AB_ModuleController<PC_PropertyTypesEntity, PC_PropertyTypesVM, PC_PropertyTypesMaps>
    {
        /// <summary>
        ...
        /// <returns>JsonResult.</returns>
        [AB_AjaxOnly]
        public JsonResult Search(AB_ModuleSearchModel moduleSearchModel, PC_PropertyTypesEntity entity)
        {
        ...
        public JsonResult Update(AB_ModuleDetailModel moduleDetailModel, PC_PropertyTypesEntity entity)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public JsonResult Insert(AB_ModuleDetailModel moduleDetailModel, PC_PropertyTypesEntity entity)
        {
