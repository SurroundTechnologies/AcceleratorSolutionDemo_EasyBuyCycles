...
namespace MVC.EasyBuyCycles.Controllers
{
    ...
    [Authorize]
    [AB_CompressContent]
    public class OrderController : AB_ModuleController<OrderEntity, OrderVM, OrderMaps>
    {
        /// <summary>
        ...
        /// <returns>JsonResult.</returns>
        [AB_AjaxOnly]
        public JsonResult Search(AB_ModuleSearchModel moduleSearchModel, OrderEntity entity)
        {
        ...
        public JsonResult Update(AB_ModuleDetailModel moduleDetailModel, OrderEntity entity)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public JsonResult Insert(AB_ModuleDetailModel moduleDetailModel, OrderEntity entity)
        {
