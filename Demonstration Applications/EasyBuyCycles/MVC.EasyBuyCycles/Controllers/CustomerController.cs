...
namespace MVC.EasyBuyCycles.Controllers
{
    ...
    [Authorize]
    [AB_CompressContent]
    public class CustomerController : AB_ModuleController<CustomerEntity, CustomerVM, CustomerMaps>
    {
        /// <summary>
        ...
        /// <returns>JsonResult.</returns>
        [AB_AjaxOnly]
        public JsonResult Search(AB_ModuleSearchModel moduleSearchModel, CustomerEntity entity)
        {
        ...
        public JsonResult Update(AB_ModuleDetailModel moduleDetailModel, CustomerEntity entity)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public JsonResult Insert(AB_ModuleDetailModel moduleDetailModel, CustomerEntity entity)
        {
