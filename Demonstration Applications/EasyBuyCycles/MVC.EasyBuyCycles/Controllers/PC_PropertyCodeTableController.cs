...
using A4DN.AM.BOS.PC_PropertyCodeTableDataEntity;
using A4DN.AM.BOS.PC_PropertyCodeTableDataMaps;
using A4DN.AM.BOS.PC_PropertyCodeTableViewModel;
using System.Web.Mvc;

namespace A4DN.AM.MVC.AcceleratorMaintenance.Controllers
{
	/// <summary>
    /// Class PC_PropertyCodeTableController.
    /// </summary>
    [Authorize]
    [AB_CompressContent]
    public class PC_PropertyCodeTableController : AB_ModuleController<PC_PropertyCodeTableEntity, PC_PropertyCodeTableVM, PC_PropertyCodeTableMaps>
    {
        /// <summary>
        ...
        /// <returns>JsonResult.</returns>
        [AB_AjaxOnly]
        public JsonResult Search(AB_ModuleSearchModel moduleSearchModel, PC_PropertyCodeTableEntity entity)
        {
        ...
        public JsonResult Update(AB_ModuleDetailModel moduleDetailModel, PC_PropertyCodeTableEntity entity)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public JsonResult Insert(AB_ModuleDetailModel moduleDetailModel, PC_PropertyCodeTableEntity entity)
        {
