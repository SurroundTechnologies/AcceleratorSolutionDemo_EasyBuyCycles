...
using A4DN.AM.BOS.PC_ObjectsDataEntity;
using A4DN.AM.BOS.PC_ObjectsDataMaps;
using A4DN.AM.BOS.PC_ObjectsViewModel;
using System.Web.Mvc;

namespace A4DN.AM.MVC.AcceleratorMaintenance.Controllers
{
	/// <summary>
    /// Class PC_ObjectsController.
    /// </summary>
    [Authorize]
    [AB_CompressContent]
    public class PC_ObjectsController : AB_ModuleController<PC_ObjectsEntity, PC_ObjectsVM, PC_ObjectsMaps>
    {
        /// <summary>
        ...
        /// <returns>JsonResult.</returns>
        [AB_AjaxOnly]
        public JsonResult Search(AB_ModuleSearchModel moduleSearchModel, PC_ObjectsEntity entity)
        {
        ...
        public JsonResult Update(AB_ModuleDetailModel moduleDetailModel, PC_ObjectsEntity entity)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public JsonResult Insert(AB_ModuleDetailModel moduleDetailModel, PC_ObjectsEntity entity)
        {
