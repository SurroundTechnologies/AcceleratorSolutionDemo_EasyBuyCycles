...
namespace MVC.EasyBuyCycles.Controllers
{
    ...
    [Authorize]
    [AB_CompressContent]
    public class OrderItemController : AB_ModuleController<OrderItemEntity, OrderItemVM, OrderItemMaps>
    {
        /// <summary>
        ...
        /// <returns>JsonResult.</returns>
        [AB_AjaxOnly]
        public JsonResult Search(AB_ModuleSearchModel moduleSearchModel, OrderItemEntity entity)
        {
        ...
        public JsonResult Update(AB_ModuleDetailModel moduleDetailModel, OrderItemEntity entity)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public JsonResult Insert(AB_ModuleDetailModel moduleDetailModel, OrderItemEntity entity)
        {
