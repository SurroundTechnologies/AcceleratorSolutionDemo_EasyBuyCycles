...
// <A4DN_Template Name="MVC.Module.Controller.cs.t4" Version="8.0.0.75" GeneratedDate="7/21/2023" />
// </A4DN_GeneratedInformation>
//===============================================================================================
...
namespace MVC.EasyBuyCycles.Controllers
{
    ...
    [Authorize]
    [AB_CompressContent]
    public class ShippingAddressController : AB_ModuleController<ShippingAddressEntity, ShippingAddressVM, ShippingAddressMaps>
    {
        /// <summary>
        ...
        /// <returns>JsonResult.</returns>
        [AB_AjaxOnly]
        public JsonResult Search(AB_ModuleSearchModel moduleSearchModel, ShippingAddressEntity entity)
        {
        ...
        public JsonResult Update(AB_ModuleDetailModel moduleDetailModel, ShippingAddressEntity entity)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public JsonResult Insert(AB_ModuleDetailModel moduleDetailModel, ShippingAddressEntity entity)
        {
