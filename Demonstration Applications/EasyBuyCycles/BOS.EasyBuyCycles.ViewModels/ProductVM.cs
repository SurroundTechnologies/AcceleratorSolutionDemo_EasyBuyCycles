...
using BOS.ProductBusinessProcess;
using BOS.ProductDataEntity;

namespace BOS.ProductViewModel
{   
	/// <summary>
	...
	/// </summary>
	public class ProductVM : AB_ViewModel<ProductEntity>
	{
		...
		private void RG_SetParentProperties()
		{
			...
			ap_RemoteBPTypeFullName = "BOS.EasyBuyCycles.ViewModels.Product.ServiceProxy.ProductBPServiceContractClient";
			
			// Set Direct Access BP Type Class Name Type
			ap_DirectBPType = typeof(ProductBP);
			// Set WCF Service Endpoint Name as defined in Service Host
			ap_RemoteBPServiceName = "ProductBP.svc";
		}
        ...
        // inputArgs.ap_PropertyModelDictionary[ProductEntity.<Property>.ap_PropertyName].ap_IsReadOnly = true;
		...
		/// </summary>            
		public override void am_SetUpVisualModelForContent(AB_VisualModelInitArgs inputArgs, System.Collections.IList currentSelectedItems, ProductEntity focusedItem)
		{
		...
		/// </summary>       
		public override void am_SetUpVisualModelForDetail(AB_VisualModelInitArgs inputArgs, ProductEntity currentDataContext)
		{
		...
		/// </summary>        
		protected override void am_OnCurrentEntityPropertyChanged(AB_VisualModelInitArgs inputArgs, string propertyName, ProductEntity currentEntity)
		{
