...
{   
	...
	public class ShippingAddressVM : AB_ViewModel<ShippingAddressEntity>
	{
		...
		private void RG_SetParentProperties()
		{
			...
			ap_RemoteBPTypeFullName = "BOS.EasyBuyCycles.ViewModels.ShippingAddress.ServiceProxy.ShippingAddressBPServiceContractClient";
			
			// Set Direct Access BP Type Class Name Type
			ap_DirectBPType = typeof(ShippingAddressBP);
			// Set WCF Service Endpoint Name as defined in Service Host
			ap_RemoteBPServiceName = "ShippingAddressBP.svc";
		}
        ...
        // inputArgs.ap_PropertyModelDictionary[ShippingAddressEntity.<Property>.ap_PropertyName].ap_IsReadOnly = true;
		...
		/// </summary>            
		public override void am_SetUpVisualModelForContent(AB_VisualModelInitArgs inputArgs, System.Collections.IList currentSelectedItems, ShippingAddressEntity focusedItem)
		{
