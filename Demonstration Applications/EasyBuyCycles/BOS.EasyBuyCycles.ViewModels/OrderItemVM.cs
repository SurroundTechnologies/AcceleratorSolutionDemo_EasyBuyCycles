...
namespace BOS.OrderItemViewModel
{   
	/// <summary>
	...
	/// </summary>
	public class OrderItemVM : AB_ViewModel<OrderItemEntity>
	{
		...
		private void RG_SetParentProperties()
		{
			...
			ap_RemoteBPTypeFullName = "BOS.EasyBuyCycles.ViewModels.OrderItem.ServiceProxy.OrderItemBPServiceContractClient";
			
			// Set Direct Access BP Type Class Name Type
			ap_DirectBPType = typeof(OrderItemBP);
			// Set WCF Service Endpoint Name as defined in Service Host
			ap_RemoteBPServiceName = "OrderItemBP.svc";
		}
        ...
        // inputArgs.ap_PropertyModelDictionary[OrderItemEntity.<Property>.ap_PropertyName].ap_IsReadOnly = true;
		...
		/// </summary>            
		public override void am_SetUpVisualModelForContent(AB_VisualModelInitArgs inputArgs, System.Collections.IList currentSelectedItems, OrderItemEntity focusedItem)
		{
		...
		/// </summary>       
		public override void am_SetUpVisualModelForDetail(AB_VisualModelInitArgs inputArgs, OrderItemEntity currentDataContext)
		{
		...
		/// </summary>        
		protected override void am_OnCurrentEntityPropertyChanged(AB_VisualModelInitArgs inputArgs, string propertyName, OrderItemEntity currentEntity)
		{
