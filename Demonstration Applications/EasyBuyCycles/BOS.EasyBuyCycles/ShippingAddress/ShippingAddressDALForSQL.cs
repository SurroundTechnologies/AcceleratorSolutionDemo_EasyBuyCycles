...
// <A4DN_Template Name="BOS.Module.DALForSQL.t4" Version="8.0.0.75" GeneratedDate="7/21/2023" />
// </A4DN_GeneratedInformation>
//===============================================================================================
using System;
...
namespace BOS.ShippingAddressDataAccessLayer
{
	/// <summary>
	/// Contains operations for data access and IO.
	/// </summary>
	[AspNetCompatibilityRequirements(RequirementsMode = AspNetCompatibilityRequirementsMode.Allowed)]
	public class ShippingAddressDALForSQL : AB_BusinessObjectDALBaseForSQL<ShippingAddressEntity>, BOS.ShippingAddressDataAccessLayer.IShippingAddressDALServiceContract
	{
		...
		/// </summary>
		protected static ShippingAddressMaps ShippingAddressMaps = new ShippingAddressMaps();
		...
		{           
			 // Load Data Maps 
			 DataMapContainer = am_MergeMaps(ShippingAddressMaps, null);            
		}
		...
		/// </summary>
		static ShippingAddressDALForSQL()
		{
			RG_StaticInitialize();
		}  
		...
		//// A4DN_Tag: Add Custom Method Example - Step 2: Implement Method as defined in the Interface  IShippingAddressDALServiceContract
		//// My Custom Method 
		////=============================================================
