...
// <A4DN_Template Name="BOS.Module.DALServiceContract.t4" Version="8.0.0.75" GeneratedDate="7/21/2023" />
// </A4DN_GeneratedInformation>
//===============================================================================================
using System;
...
namespace BOS.ShippingAddressDataAccessLayer
{
	...
	/// </summary>
	[ServiceContract]
	public interface IShippingAddressDALServiceContract : AB_IBusinessObjectDALBaseServiceContract<ShippingAddressEntity>
	{
