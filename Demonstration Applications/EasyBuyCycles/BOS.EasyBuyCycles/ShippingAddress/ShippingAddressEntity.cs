...
namespace BOS.ShippingAddressDataEntity
{
	...
	public class ShippingAddressEntity : AB_BusinessObjectEntityBase
	{
		...
		static private void RG_DoStaticInit()
		{
			...
			AB_BusinessObjectEntityBase.am_GetPropertyInfo(typeof(ShippingAddressEntity), typeof(BOS.EasyBuyCycles.Properties.MessageResource), typeof(MessageResource), typeof(BOS.EasyBuyCycles.Properties.DescriptionResource), typeof(DescriptionResource), out _EntityInfo); 
		}  
		...
		[DataMember]
		public string Address1 //Map Field: Address1
		{
			get { return am_GetPropertyValue(Address1Property); }
			set {  am_SetPropertyValue(Address1Property, value); }
		}
		public static AB_PropertyMetadata<string> Address1Property = am_CreatePropertyMetaData<string>("Address1", DescriptionResource.ADDRESS1, null); 

		[Display(Name="ADDRESS2", ResourceType=typeof(DescriptionResource))]
		[DataMember]
		public string Address2 //Map Field: Address2
		{
			get { return am_GetPropertyValue(Address2Property); }
			set {  am_SetPropertyValue(Address2Property, value); }
		}
		public static AB_PropertyMetadata<string> Address2Property = am_CreatePropertyMetaData<string>("Address2", DescriptionResource.ADDRESS2, null); 

		[Display(Name="ADDRESS3", ResourceType=typeof(DescriptionResource))]
		[DataMember]
		public string Address3 //Map Field: Address3
		{
			get { return am_GetPropertyValue(Address3Property); }
			set {  am_SetPropertyValue(Address3Property, value); }
		}
		public static AB_PropertyMetadata<string> Address3Property = am_CreatePropertyMetaData<string>("Address3", DescriptionResource.ADDRESS3, null); 

		[Display(Name="POSTALCODE", ResourceType=typeof(DescriptionResource))]
		[DataMember]
		public string PostalCode //Map Field: PostalCode
		{
			get { return am_GetPropertyValue(PostalCodeProperty); }
			set {  am_SetPropertyValue(PostalCodeProperty, value); }
		}
		public static AB_PropertyMetadata<string> PostalCodeProperty = am_CreatePropertyMetaData<string>("PostalCode", DescriptionResource.POSTALCODE, null); 

		[Display(Name="COUNTRY", ResourceType=typeof(DescriptionResource))]
		[DataMember]
		public string Country //Map Field: Country
		{
			get { return am_GetPropertyValue(CountryProperty); }
			set {  am_SetPropertyValue(CountryProperty, value); }
		}
		public static AB_PropertyMetadata<string> CountryProperty = am_CreatePropertyMetaData<string>("Country", DescriptionResource.COUNTRY, null); 
