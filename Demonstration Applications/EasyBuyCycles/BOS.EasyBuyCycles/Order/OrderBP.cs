...
namespace BOS.OrderBusinessProcess
{
	...
	public class OrderBP : AB_FrameworkBusinessObjectProcessBase<OrderEntity>, IOrderBPServiceContract
	{
		...
		private void RG_SetParentProperties()
		{
			...
			ap_ServiceDalTypeFullName = "BOS.EasyBuyCycles.Order.ServiceProxy.OrderDALServiceContractClient";
		...
		{ 
			switch (inputArgs.ap_CommandID)
			{
				//case "MyCommandID":
					...
					//return new AB_ProcessRequestReturnArgs<OrderEntity>("OK", new List<A4DN.Core.BOS.DataController.AB_Message>(), null, null);
				default:
