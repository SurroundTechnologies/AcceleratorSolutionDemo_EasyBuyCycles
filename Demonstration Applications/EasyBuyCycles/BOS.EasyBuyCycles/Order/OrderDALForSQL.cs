...
namespace BOS.OrderDataAccessLayer
{
	/// <summary>
	/// Contains operations for data access and IO.
	/// </summary>
	[AspNetCompatibilityRequirements(RequirementsMode = AspNetCompatibilityRequirementsMode.Allowed)]
	public class OrderDALForSQL : AB_BusinessObjectDALBaseForSQL<OrderEntity>, BOS.OrderDataAccessLayer.IOrderDALServiceContract
	{
		...
		/// </summary>
		protected static OrderMaps OrderMaps = new OrderMaps();
		...
		{           
			 // Load Data Maps 
			 DataMapContainer = am_MergeMaps(OrderMaps, null);            
		}
		...
		//// A4DN_Tag: Add Custom Method Example - Step 2: Implement Method as defined in the Interface  IOrderDALServiceContract
		//// My Custom Method 
		////=============================================================
