...
namespace BOS.CustomerBusinessProcess
{
	/// <summary>
	...
	/// </summary>
	[ServiceContract]
	public interface ICustomerBPServiceContract : AB_IBusinessObjectProcessBaseServiceContract<CustomerEntity>
	{
	...
	public class CustomerBP : AB_FrameworkBusinessObjectProcessBase<CustomerEntity>, ICustomerBPServiceContract
	{
		...
		private void RG_SetParentProperties()
		{
			...
			ap_ServiceDalTypeFullName = "BOS.EasyBuyCycles.Customer.ServiceProxy.CustomerDALServiceContractClient";
			// Set Direct Access DAL Type Class Name Type
			ap_DirectAccessDalType = typeof(CustomerDALForSQL);
			// Set WCF Service Endpoint Name as defined in Service Host
			ap_SvcName = "CustomerDAL.svc";
		}
		...
		{ 
			switch (inputArgs.ap_CommandID)
			{
				//case "MyCommandID":
					...
					//return new AB_ProcessRequestReturnArgs<CustomerEntity>("OK", new List<A4DN.Core.BOS.DataController.AB_Message>(), null, null);
				default:
		...
		//        return ((CustomerDALServiceContractClient)ap_DalObject).MyCustomMethod(inputArgs);
		//    }
		//    else
		//    {
		//        // Call using Direct Access
		//        return ((CustomerDALForSQL)ap_DalObject).MyCustomMethod(inputArgs);
		//    }
		//}
		...
		//// My Custom Select
		////=============================================================
		//public AB_SelectReturnArgs<CustomerEntity> SelectContactByID(AB_SelectInputArgs<MyCustomSearchEntity> inputArgs)
		//{
		//    CustomerEntity EntityWithSearchCriteria = new CustomerEntity() { SomeProperty = inputArgs.EntityWithSelectionParams.SomeProperty };
		//    AB_SelectInputArgs<CustomerEntity> fullInputArgs = new AB_SelectInputArgs<CustomerEntity>("MyView", inputArgs.ap_Method, EntityWithSearchCriteria, null, inputArgs.ap_MaxCount, false);
		//    return (AB_SelectReturnArgs<CustomerEntity>)am_Select((AB_SelectInputArgs)fullInputArgs);
		//}
