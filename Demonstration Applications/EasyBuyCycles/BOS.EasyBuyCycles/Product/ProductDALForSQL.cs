...
namespace BOS.ProductDataAccessLayer
{
	/// <summary>
	/// Contains operations for data access and IO.
	/// </summary>
	[AspNetCompatibilityRequirements(RequirementsMode = AspNetCompatibilityRequirementsMode.Allowed)]
	public class ProductDALForSQL : AB_BusinessObjectDALBaseForSQL<ProductEntity>, BOS.ProductDataAccessLayer.IProductDALServiceContract
	{
		...
		/// </summary>
		protected static ProductMaps ProductMaps = new ProductMaps();
		...
		{           
			 // Load Data Maps 
			 DataMapContainer = am_MergeMaps(ProductMaps, null);            
		}
