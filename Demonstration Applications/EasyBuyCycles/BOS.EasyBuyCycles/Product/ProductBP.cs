...
using BOS.ProductDataAccessLayer;

namespace BOS.ProductBusinessProcess
{
	/// <summary>
	...
	/// </summary>
	[ServiceContract]
	public interface IProductBPServiceContract : AB_IBusinessObjectProcessBaseServiceContract<ProductEntity>
	{
	...
	public class ProductBP : AB_FrameworkBusinessObjectProcessBase<ProductEntity>, IProductBPServiceContract
	{
		...
		private void RG_SetParentProperties()
		{
			...
			ap_ServiceDalTypeFullName = "BOS.EasyBuyCycles.Product.ServiceProxy.ProductDALServiceContractClient";
			// Set Direct Access DAL Type Class Name Type
			ap_DirectAccessDalType = typeof(ProductDALForSQL);
			// Set WCF Service Endpoint Name as defined in Service Host
			ap_SvcName = "ProductDAL.svc";
		}
		...
		{ 
			switch (inputArgs.ap_CommandID)
			{
				//case "MyCommandID":
					...
					//return new AB_ProcessRequestReturnArgs<ProductEntity>("OK", new List<A4DN.Core.BOS.DataController.AB_Message>(), null, null);
				default:
		...
		//        return ((ProductDALServiceContractClient)ap_DalObject).MyCustomMethod(inputArgs);
		//    }
		//    else
		//    {
		//        // Call using Direct Access
		//        return ((ProductDALForSQL)ap_DalObject).MyCustomMethod(inputArgs);
		//    }
		//}
		...
		//// My Custom Select
		////=============================================================
		//public AB_SelectReturnArgs<ProductEntity> SelectContactByID(AB_SelectInputArgs<MyCustomSearchEntity> inputArgs)
		//{
		//    ProductEntity EntityWithSearchCriteria = new ProductEntity() { SomeProperty = inputArgs.EntityWithSelectionParams.SomeProperty };
		//    AB_SelectInputArgs<ProductEntity> fullInputArgs = new AB_SelectInputArgs<ProductEntity>("MyView", inputArgs.ap_Method, EntityWithSearchCriteria, null, inputArgs.ap_MaxCount, false);
		//    return (AB_SelectReturnArgs<ProductEntity>)am_Select((AB_SelectInputArgs)fullInputArgs);
		//}
