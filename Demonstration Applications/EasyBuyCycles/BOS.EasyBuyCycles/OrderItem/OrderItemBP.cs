...
// <A4DN_Template Name="BOS.Module.BP.t4" Version="8.0.0.75" GeneratedDate="7/21/2023" />
// </A4DN_GeneratedInformation>
//===============================================================================================
using System;
...
using BOS.OrderItemDataAccessLayer;

namespace BOS.OrderItemBusinessProcess
{
	/// <summary>
	...
	/// </summary>
	[ServiceContract]
	public interface IOrderItemBPServiceContract : AB_IBusinessObjectProcessBaseServiceContract<OrderItemEntity>
	{
	...
	public class OrderItemBP : AB_FrameworkBusinessObjectProcessBase<OrderItemEntity>, IOrderItemBPServiceContract
	{
		...
		private void RG_SetParentProperties()
		{
			...
			ap_ServiceDalTypeFullName = "BOS.EasyBuyCycles.OrderItem.ServiceProxy.OrderItemDALServiceContractClient";
			// Set Direct Access DAL Type Class Name Type
			ap_DirectAccessDalType = typeof(OrderItemDALForSQL);
			// Set WCF Service Endpoint Name as defined in Service Host
			ap_SvcName = "OrderItemDAL.svc";
		}
		...
		{ 
			switch (inputArgs.ap_CommandID)
			{
				//case "MyCommandID":
					...
					//return new AB_ProcessRequestReturnArgs<OrderItemEntity>("OK", new List<A4DN.Core.BOS.DataController.AB_Message>(), null, null);
				default:
		...
		//        return ((OrderItemDALServiceContractClient)ap_DalObject).MyCustomMethod(inputArgs);
		//    }
		//    else
		//    {
		//        // Call using Direct Access
		//        return ((OrderItemDALForSQL)ap_DalObject).MyCustomMethod(inputArgs);
		//    }
		//}
		...
		//// My Custom Select
		////=============================================================
		//public AB_SelectReturnArgs<OrderItemEntity> SelectContactByID(AB_SelectInputArgs<MyCustomSearchEntity> inputArgs)
		//{
		//    OrderItemEntity EntityWithSearchCriteria = new OrderItemEntity() { SomeProperty = inputArgs.EntityWithSelectionParams.SomeProperty };
		//    AB_SelectInputArgs<OrderItemEntity> fullInputArgs = new AB_SelectInputArgs<OrderItemEntity>("MyView", inputArgs.ap_Method, EntityWithSearchCriteria, null, inputArgs.ap_MaxCount, false);
		//    return (AB_SelectReturnArgs<OrderItemEntity>)am_Select((AB_SelectInputArgs)fullInputArgs);
		//}
