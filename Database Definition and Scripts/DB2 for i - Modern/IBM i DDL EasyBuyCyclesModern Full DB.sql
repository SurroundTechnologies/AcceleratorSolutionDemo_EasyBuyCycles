...
CREATE OR REPLACE TABLE "Customer"
    (
     ...
     "ContactLastName"      FOR "YD1CCNLN" NVARCHAR(50),
     "ContactFirstName"     FOR "YD1CCNFN" NVARCHAR(50),
     "ContactMiddleName"    FOR "YD1CCNMN" NVARCHAR(50),
     "ContactNickName"      FOR "YD1CCNNN" NVARCHAR(50),
     "BillingAddress1"      FOR "YD1CBLA1" NVARCHAR(30),
     "BillingAddress2"      FOR "YD1CBLA2" NVARCHAR(30),
     "BillingAddress3"      FOR "YD1CBLA3" NVARCHAR(30),
     "BillingPostalCode"    FOR "YD1CBLPC" NVARCHAR(10),
     "BillingCountry"       FOR "YD1CBLCY" NVARCHAR(50),
...
CREATE OR REPLACE TABLE "ShippingAddress"
    FOR SYSTEM NAME "ShpAddr"  (
     ...
     "ContactLastName"      FOR "YD1SCNLN" NVARCHAR(50),
     "ContactFirstName"     FOR "YD1SCNFN" NVARCHAR(50),
     "ContactMiddleName"    FOR "YD1SCNMN" NVARCHAR(50),
     "ContactNickName"      FOR "YD1SCNNN" NVARCHAR(50),
     "Address1"             FOR "YD1SSHA1" NVARCHAR(30),
     "Address2"             FOR "YD1SSHA2" NVARCHAR(30),
     "Address3"             FOR "YD1SSHA3" NVARCHAR(30),
     "PostalCode"           FOR "YD1SSHPC" NVARCHAR(10),
     "Country"              FOR "YD1SSHCY" NVARCHAR(50),
...
CREATE OR REPLACE TABLE "Product"
    (
     ...
     "Description"          FOR "YD1PDS" NVARCHAR(256) NOT NULL,
     "Category"             FOR "YD1PCT" NVARCHAR(50),
     "StandardCost"         FOR "YD1PSTCS" NUMERIC(10,2),
     "ListPrice"            FOR "YD1PLSPR" NUMERIC(10,2),
...
DROP INDEX IF EXISTS
   "IX_Order_CustomerInternalID_OrderDateTime_InternalID";
DROP INDEX IF EXISTS
   "IX_Order_CustomerInternalID_ PO_OrderDateTime_InternalID";
...
CREATE OR REPLACE TABLE "Order"
    (
     ...
     "PurchaseOrderNumber/ID" FOR "YD1OPONO" CHAR(50),
...
CREATE INDEX "IX_Order_CustomerInternalID_OrderDateTime_InternalID"
   ...
   ON "Order" (
   "CustomerInternalID", "OrderDateTime", "InternalID"
   );
...
CREATE INDEX "IX_Order_CustomerInternalID_ PO_OrderDateTime_InternalID"
   ...
   ON "Order" (
   "CustomerInternalID",  "PurchaseOrderNumber/ID", "OrderDateTime",
   "InternalID"
   );
...
CREATE INDEX "IX_Order_PO_OrderDateTime_InternalID"
   ...
   ON "Order" (
   "PurchaseOrderNumber/ID", "OrderDateTime", "InternalID"
   );
...
CREATE INDEX "IX_Order_SalesPersonName_OrderDateTime_InternalID"
   ...
   ON "Order" (
   "SalesPersonName", "OrderDateTime", "InternalID"
   );
...
CREATE INDEX "IX_Order_WarehouseName_OrderDateTime_InternalID"
   ...
   ON "Order" (
   "WarehouseName", "OrderDateTime", "InternalID"
   );
...
CREATE INDEX "IX_Order_Status_OrderDateTime_InternalID"
   ...
   ON "Order" (
   "Status", "OrderDateTime", "InternalID"
   );
...
CREATE INDEX
   ...
   ON "Order" (
   "CustomerInternalID", "Status", "OrderDateTime", "InternalID"
   );
LABEL ON INDEX
   "IX_Order_CustomerInternalID_Status_OrderDateTime_InternalID"
...
CREATE INDEX
   ...
   ON "Order" (
   "ShippingAddressInternalID", "OrderDateTime", "InternalID"
   );
LABEL ON INDEX 
   "IX_Order_ShippingAddressInternalID_OrderDateTime_InternalID"
