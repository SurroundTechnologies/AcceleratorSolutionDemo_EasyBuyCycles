...
CREATE OR REPLACE TABLE "Order"
    (
     ...
     "PurchaseOrderNumberID" FOR "YD1OPONO" CHAR(50),
...
LABEL ON COLUMN "Order" (
     ...
     "PurchaseOrderNumberID" TEXT IS 'Purchase Order Number/ID',
...
--                             |1-------------------2-------------------3-------------------|
     ...
     "PurchaseOrderNumberID" IS 'Purchase Order      Number/Id',
...
CREATE INDEX "IX_Order_CustomerInternalID_ PO_OrderDateTime_InternalID"
   ...
   ON "Order" (
   "CustomerInternalID",  "PurchaseOrderNumberID", "OrderDateTime" DESC,
   "InternalID"
   );
...
CREATE INDEX "IX_Order_PO_OrderDateTime_InternalID"
   ...
   ON "Order" (
   "PurchaseOrderNumberID", "OrderDateTime" DESC, "InternalID"
   );
